<template>
    <b-row>
        <b-col cols="6" class="mt-2 mx-auto">
            ...
            <b-form>
                ...
                <b-row>
                    <b-col cols="6">
                        <b-button class="w-100" variant="primary" type="button" @click="update()">submit</b-button>
                    </b-col>
                    <b-col cols="6">
...
export default {
    ...
    methods:{
        edit(){
            ...
            axios
            .get(`/api/crud/${this.params}/edit`)
            .then(res => {
                this.form.name = res.data.author_name;
                this.form.product = res.data.product_name;
            });
        },
            update(){
                this.params = this.$route.params.id;
                axios
                    .put(`/api/crud/${this.params}/`,this.form)
                    .then(res=>{
                        if(res.data.status){
